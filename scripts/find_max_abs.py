...
sys.path.append("/groups/kemi/elholm/opt/tQMC/QMC")
import qmconf
...
def run_abs_calc(df_x):
    ...
    xyz = str(df_x.reac.label)+'.xyz'
    df_x.reac.write_xyz(to_file=True)
...
if __name__ == '__main__':
    ...
    data.to_pickle(sys.argv[1].split('/')[0].split('.')[0] + '_abs.pkl')
